...
The InControl platform allows card-holders to create virtual payment cards. The virtual cards are linked back to the original real card and account and can be used exactly like a normal payment card.
