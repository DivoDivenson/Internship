...
My primary goal was to learn new technical skills. I also wanted the experience of working within a professional environment to help my own personal development. I was also concerned with identifying areas of weakness. The focus of a university course is completely different to commercial company. I anticipated I would have to learn new skills on the job but I wanted to try and identify what areas university had prepared me for and what had been neglected. 
...
\image{4party.png}{The four party model.}
...
Releases are managed by Andrew, an new web application also developed in house. Essentially it groups specific versions of components into an archive that can then be released. It interfaces with Terra to simplify selecting the components to include within a release.
...
\image{smart_mvc.png}{SMARTs code structure.}
...
\image{smart_generated_ui.png}{Generated UI for an AddIssuerScheme request} 
...
\textif{@Valid}: The @Valid annotation in the processForm method declares that the object passed in should first be validated. This can be done by writing a custom validation object or by simply annotating the various members of the model object with constraints.  
